...
export default function UploadKKSantri({
  fileUploadKKSantri,
  setFileUploadKKSantri,
}) {
  ...
  const handleFileSelect = (selectedFile) => {
    ...
    setFileUploadKKSantri(selectedFile);
  };
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium truncate">
                    {fileUploadKKSantri.name}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {formatFileSize(fileUploadKKSantri.size)}
                  </p>
                </div>
              </div>
              <Button
