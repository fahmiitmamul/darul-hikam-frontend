...
export default function UploadPKHOrangTua({
  fileUploadPKHOrangTua,
  setFileUploadPKHOrangTua,
}) {
  ...
  const handleFileSelect = (selectedFile) => {
    ...
    setFileUploadPKHOrangTua(selectedFile);
  };
  ...
  return (
    <div className="w-full max-w-md space-y-4">
      <div className="space-y-2">
        <Label htmlFor="pdf-upload">Upload PKH Orang Tua</Label>
        <Card
          className={cn(
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium truncate">
                    {fileUploadPKHOrangTua.name}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {formatFileSize(fileUploadPKHOrangTua.size)}
                  </p>
                </div>
              </div>
              <Button
