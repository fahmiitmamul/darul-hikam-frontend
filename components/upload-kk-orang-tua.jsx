...
export default function UploadKKOrangTua({
  fileUploadKKOrangTua,
  setFileUploadKKOrangTua,
}) {
  ...
  const handleFileSelect = (selectedFile) => {
    ...
    setFileUploadKKOrangTua(selectedFile);
  };
  ...
  return (
    <div className="w-full max-w-md space-y-4">
      <div className="space-y-2">
        <Label htmlFor="pdf-upload">Upload KK Orang Tua</Label>
        <Card
          className={cn(
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium truncate">
                    {fileUploadKKOrangTua.name}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {formatFileSize(fileUploadKKOrangTua.size)}
                  </p>
                </div>
              </div>
              <Button
